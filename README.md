...
### MongoDB (Optional)
The MUD will show a MongoDB connection error if MongoDB isn't running. This is normal and doesn't prevent the MUD from functioning. To use MongoDB features, install and start MongoDB:
